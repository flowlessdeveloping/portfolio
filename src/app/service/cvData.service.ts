      ...
      details: [
        {
          ...
          description:
            'Thesis: Implementation of Centrality Measures on Big Data Technologies and Performance Analysis.',
      ...
      details: [
        {
          ...
          description:
            'Proficiency in building scalable and maintainable frontend applications.',
          technologies:
            'Angular, TypeScript, HTML, CSS, JavaScript, Bootstrap, NgRx, Jest, Cypress',
        },
        {
          title: 'Backend Development',
          description:
            'Experience in developing and maintaining backend services.',
          technologies: 'Java Spring Boot, Node.js, SQL, PostgreSQL, Oracle',
        },
        {
          title: 'DevOps & Tools',
          description:
            'Familiarity with version control, CI/CD pipelines, and development tools.',
          technologies:
            'Git, GitLab, Jenkins, Jira, Docker, Postman, IntelliJ IDEA, VS Code',
        },
        {
          title: 'Methodologies',
          description:
            'Experienced in Agile frameworks and modern software development practices.',
          technologies:
            'Agile (Scrum, Kanban), CI/CD, Code Reviews, API Development',
        },
      ],
    },
    {
      ...
      details: [
        {
          ...
          description:
            'Experienced in leading teams, mentoring developers, and conducting technical interviews.',
          technologies: '',
        },
        {
          title: 'Problem-Solving & Debugging',
          description:
            'Strong analytical and debugging skills to ensure application stability and efficiency.',
          technologies: '',
        },
        {
          title: 'Technical Communication & Documentation',
          description:
            'Ability to clearly document and communicate technical concepts.',
          technologies: '',
        },
        {
          title: 'Agile Development & Collaboration',
          description:
            'Skilled in working within Agile teams and fostering collaboration.',
          technologies: '',
        },
      ],
    },
      ...
      details: [
        {
          ...
          description:
            'Presented a talk on frontend development best practices.',
          technologies: '',
        },
      ],
    },
